...
public class Referer {
  ...
  public boolean equals(Object other) {
    ...
    return ((this.medium != null && this.medium.equals(r.medium)) || this.medium == r.medium) &&
           ((this.source != null && this.source.equals(r.source)) || Objects.equals(this.source, r.source)) &&
           ((this.term != null && this.term.equals(r.term)) || Objects.equals(this.term, r.term));
  }
